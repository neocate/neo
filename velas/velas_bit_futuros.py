# ================================================================================
# velas_bit_futuros.py - PERPETUO USDT-M (ETH/USDT:USDT)
#
# Fija el mercado y reexpone la API de velas_bit.py ya atada a el. No hay
# logica aqui: la maquinaria es unica y esta en velas_bit.py. Este fichero
# existe para que el mercado se elija IMPORTANDO, no pasando un argumento que
# se puede olvidar o equivocar.
#
#   import velas_bit_futuros as velas
#   velas.poner_al_dia('eth', '5m')
#   velas.ultimas_velas('eth', '1h', 200)
#
# El equivalente al contado es velas_bit_spot.py. Los dos pueden convivir
# en el mismo proceso sin pisarse: no hay estado global de mercado, cada
# llamada lleva el suyo atado aqui.
#
...
# Constantes que no dependen del mercado, reexpuestas tal cual.
...
# --- API atada a 'futuros' -------------------------------------------------
# Envoltorios explicitos y no functools.partial: 'mercado' va en medio de la
# firma, asi que un partial por keyword chocaria con el tercer posicional de
# las que llevan argumentos detras (bajar_por_lotes, ultimas_velas, log).
