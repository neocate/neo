...
# En master los indicadores viven en indicadores/, no en mercado/ (esta
# division ya existia cuando este modulo se escribio en la rama senales-vela).
import os
import sys
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "indicadores"))
import indicadores
